package mx.santander.fiduciario.instruccionregistro.controller.exception;
...
import mx.santander.fiduciario.instruccionregistro.exception.InstruccionRegistroServiceException;
import mx.santander.fiduciario.instruccionregistro.controller.exception.model.DefaultError;
import mx.santander.fiduciario.instruccionregistro.controller.exception.model.DefaultErrorList;
 ...
 */
@ControllerAdvice
public class InstruccionRegistroControllerExceptionHandler {

	private static final Logger LOGGER = LoggerFactory.getLogger(InstruccionRegistroControllerExceptionHandler.class);
     ...
     * @param ex Excepcion de registro inexsistente InstruccionRegistroInexistenteException
     * @return La entidad de respuesta que maneja el error como objeto
     */
    @ExceptionHandler(InstruccionRegistroInexistenteException.class)
    public ResponseEntity<DefaultErrorList> handleInstruccionRegistroInexistenteException(InstruccionRegistroInexistenteException ex) {
     ...
     * @return La entidad de respuesta que maneja el error como objeto
     */
    @ExceptionHandler(InstruccionRegistroServiceException.class)
    public ResponseEntity<DefaultErrorList> handleInstruccionRegistroServiceException(InstruccionRegistroServiceException ex) {
    	LOGGER.error("Error en la ejecucion del servicio InstruccionRegistro", ex);
